...
private:
     ...
     */
    std::map<cl7::string, std::vector<cl7::string>> _option_values;
...
public:
     ...
     */
    bool has_option(const cl7::string& option_name) const;

    /**
     * Returns the option value found for the specified option, or an empty string
     * if not found.
     */
    const cl7::string& get_value(const cl7::string& option_name) const;

    /**
     * Returns a list of option values found for the specified option, or an empty
     * list if not found.
     */
    const std::vector<cl7::string>& get_values(const cl7::string& option_name) const;
