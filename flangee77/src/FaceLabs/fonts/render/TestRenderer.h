...
private:
    struct Vertex
    {
        ...
        xl7::graphics::Color outline_color; // Unused by the shader; kept only to match the shared vertex layout.
        float outline_width; // Unused by the shader; kept only to match the shared vertex layout.
    };
