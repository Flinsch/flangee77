...
private:
    ...
    // icon may reference an arbitrary caller-supplied texture instead of a shared
    // glyph atlas layer.
    std::vector<Vertex> _icon_vertices;
    std::vector<IconDrawBatch> _icon_batches;
