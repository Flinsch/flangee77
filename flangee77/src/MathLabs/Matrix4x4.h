...
public:
     ...
     */
    constexpr explicit Matrix4x4(const Matrix3x3& m3x3)
     ...
     */
    constexpr Matrix4x4(const Matrix3x3& m3x3, const ml7::Vector3& translation)
     ...
     */
    constexpr explicit Matrix4x4(const Matrix3x4& m3x4)
     ...
     */
    static Matrix4x4 rotx(float theta) { return rotx( ::sinf( theta ), ::cosf( theta ) ); }
     ...
     */
    static Matrix4x4 roty(float theta) { return roty( ::sinf( theta ), ::cosf( theta ) ); }
     ...
     */
    static Matrix4x4 rotz(float theta) { return rotz( ::sinf( theta ), ::cosf( theta ) ); }
     ...
     * (in radians).
     */
    static Matrix4x4 rotation(const ml7::Vector3& v)
    {
     ...
     */
    static Matrix4x4 rotation(const ml7::Vector3& v, float theta)
    {
        if ( !theta )
            return IDENTITY;
     ...
     */
    static Matrix4x4 rotation_normalized(const ml7::Vector3& u, float theta);
     ...
     * translation vector.
     */
    static Matrix4x4 compose(float scaling, const ml7::Vector3& axis, float theta, const ml7::Vector3& translation)
    {
     ...
     * translation vector.
     */
    static Matrix4x4 compose(const ml7::Vector3& scaling, const ml7::Vector3& axis, float theta, const ml7::Vector3& translation);
...
public:
     ...
     */
    void to_axes(ml7::Vector4& x, ml7::Vector4& y, ml7::Vector4& z, ml7::Vector4& w)
    {
...
public:
    ...
    constexpr Matrix4x4 operator - () const { return Matrix4x4( -_11, -_12, -_13, -_14, -_21, -_22, -_23, -_24, -_31, -_32, -_33, -_34, -_41, -_42, -_43, -_44 ); }

    /** Returns the (element-wise) matrix sum of two matrices. */
    constexpr Matrix4x4 operator + (const Matrix4x4& m) const { return Matrix4x4( _11 + m._11, _12 + m._12, _13 + m._13, _14 + m._14, _21 + m._21, _22 + m._22, _23 + m._23, _24 + m._24, _31 + m._31, _32 + m._32, _33 + m._33, _34 + m._34, _41 + m._41, _42 + m._42, _43 + m._43, _44 + m._44 ); }
    ...
    constexpr Matrix4x4 operator * (float s) const { return Matrix4x4( _11 * s, _12 * s, _13 * s, _14 * s, _21 * s, _22 * s, _23 * s, _24 * s, _31 * s, _32 * s, _33 * s, _34 * s, _41 * s, _42 * s, _43 * s, _44 * s ); }
...
public:
    ...
    constexpr Matrix4x4& operator *= (float s) { for ( unsigned k = 0; k < 16; ++k ) data[k] *= s; return *this; }
