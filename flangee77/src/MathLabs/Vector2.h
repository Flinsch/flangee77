...
public:
     ...
     * dot product of both vectors in which this vector is replaced by the
...
public:
    ...
    constexpr Vector2 operator * (float s, const Vector2& v) { return Vector2( s * v.x, s * v.y ); }
