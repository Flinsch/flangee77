...
struct CubicBezier2
{
     ...
     */
    constexpr CubicBezier2(const Vector2& p0, const Vector2& p1, const Vector2& p2, const Vector2& p3) noexcept
        : p0(p0)
        , p1(p1)
        , p2(p2)
        , p3(p3)
     ...
     */
    std::span<const Vector2> control_points() const { return {&p0, 4}; }
     ...
     * than 1.
     */
    std::pair<CubicBezier2, CubicBezier2> subdivide(float t) const;
