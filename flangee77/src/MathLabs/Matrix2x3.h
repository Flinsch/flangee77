...
public:
     ...
     */
    constexpr explicit Matrix2x3(const Matrix2x2& m2x2)
     ...
     */
    constexpr Matrix2x3(const Matrix2x2& m2x2, const ml7::Vector2& translation)
...
public:
    ...
    constexpr Matrix2x3 operator - () const { return Matrix2x3( -a, -b, -c, -d, -e, -f ); }
