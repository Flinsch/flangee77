...
namespace cl7::io {
     ...
     */
    size_t Utf8Writer::write(cl7::u8string_view text)
    {
     ...
     */
    size_t Utf8Writer::write_line(cl7::u8string_view line, cl7::u8string_view line_break)
    {
     ...
     */
    size_t Utf8Writer::write_char(cl7::u8char_t chr)
    {
