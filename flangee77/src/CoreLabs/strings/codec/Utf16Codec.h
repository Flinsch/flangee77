#ifndef CL7_STRINGS_CODEC_UTF16CODEC_H
#define CL7_STRINGS_CODEC_UTF16CODEC_H
...
public:
    ...
    static size_t determine_encode_length(codepoint codepoint, codec::codepoint replacement = default_replacement);
...
#endif // CL7_STRINGS_CODEC_UTF16CODEC_H
