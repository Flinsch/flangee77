...
private:
    ...
    // #############################################################################
private:
    _XL7_GRAPHICS_PIPELINE_STATE_ARRAY_DEFAULT0( vertex_buffer_id, MAX_VERTEX_STREAMS, resources::ResourceID, resources::ResourceID::INVALID_ID, DIRTY_VERTEX_BUFFER_FLAG_BASE );
    _XL7_GRAPHICS_PIPELINE_SINGLE_STATE( index_buffer_id, resources::ResourceID, resources::ResourceID::INVALID_ID, DIRTY_INDEX_BUFFER_FLAG );
    _XL7_GRAPHICS_PIPELINE_SINGLE_STATE( topology, meshes::Topology, meshes::Topology::Undefined, DIRTY_TOPOLOGY_FLAG );
