...
namespace xl7::graphics::textures {
        ...
        , _desc(desc)
    {
        ...
        if (capabilities.textures.max_texture_array_size && desc.count > capabilities.textures.max_texture_array_size)
            LOG_WARNING(u8"The " + get_typed_identifier_string() + u8" to be created should have " + cl7::to_string(desc.count) + u8" slices, but a maximum of " + cl7::to_string(capabilities.textures.max_texture_array_size) + u8" is supported.");
    }
