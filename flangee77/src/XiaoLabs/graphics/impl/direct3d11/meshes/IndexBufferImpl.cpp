...
namespace meshes {
     ...
     * it contains additional implementation-specific information.
     */
    bool IndexBufferImpl::_update_impl(const DataProvider& data_provider, bool discard, bool no_overwrite)
    {
        ...
        else // => _desc.usage == ResourceUsage::Default
        {
            ...
            d3d_device_context->UpdateSubresource1( _d3d_index_buffer.Get(), 0, &box, _data.data() + data_provider.get_offset(), 0, 0, copy_flags );
        }
