...
public:
     ...
     */
    static void map_d3d_values(const graphics::states::SamplerStateDesc& desc, D3D11_SAMPLER_DESC& d3d_sampler_desc);
...
private:
     ...
     */
    void* _get_raw_resource_impl() const override { return _d3d_sampler_state.Get(); }
