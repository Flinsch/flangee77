...
namespace xl7::graphics::impl::direct3d11::states {
    ...
    static D3D11_STENCIL_OP _d3d_stencil_op_from(graphics::states::StencilOperation stencil_operation)
    {
        ...
        static_assert(static_cast<unsigned>(graphics::states::StencilOperation::Replace) == static_cast<unsigned>(D3D11_STENCIL_OP_REPLACE));
        static_assert(static_cast<unsigned>(graphics::states::StencilOperation::IncrClamp) == static_cast<unsigned>(D3D11_STENCIL_OP_INCR_SAT));
        static_assert(static_cast<unsigned>(graphics::states::StencilOperation::DecrClamp) == static_cast<unsigned>(D3D11_STENCIL_OP_DECR_SAT));
        static_assert(static_cast<unsigned>(graphics::states::StencilOperation::Invert) == static_cast<unsigned>(D3D11_STENCIL_OP_INVERT));
        static_assert(static_cast<unsigned>(graphics::states::StencilOperation::IncrWrap) == static_cast<unsigned>(D3D11_STENCIL_OP_INCR));
        static_assert(static_cast<unsigned>(graphics::states::StencilOperation::DecrWrap) == static_cast<unsigned>(D3D11_STENCIL_OP_DECR));
     ...
     */
    void DepthStencilStateImpl::map_d3d_values(const graphics::states::DepthStencilStateDesc& desc, D3D11_DEPTH_STENCIL_DESC& d3d_depth_stencil_desc)
    {
