...
namespace shaders {
     ...
     * it contains additional implementation-specific information.
     */
    bool PixelShaderImpl::_acquire_recompilable_impl(const xl7::graphics::shaders::CodeProvider& code_provider, xl7::graphics::shaders::ShaderCode& bytecode_out, xl7::graphics::shaders::ParameterTable& parameter_table_out)
    {
