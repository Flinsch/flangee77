...
namespace xl7::graphics::impl::direct3d9::mappings {
    ...
    {
        static_assert(static_cast<unsigned>(graphics::states::ComparisonFunction::Never) == static_cast<unsigned>(D3DCMP_NEVER));
        static_assert(static_cast<unsigned>(graphics::states::ComparisonFunction::Less) == static_cast<unsigned>(D3DCMP_LESS));
        static_assert(static_cast<unsigned>(graphics::states::ComparisonFunction::Equal) == static_cast<unsigned>(D3DCMP_EQUAL));
        static_assert(static_cast<unsigned>(graphics::states::ComparisonFunction::LessEqual) == static_cast<unsigned>(D3DCMP_LESSEQUAL));
        static_assert(static_cast<unsigned>(graphics::states::ComparisonFunction::Greater) == static_cast<unsigned>(D3DCMP_GREATER));
        static_assert(static_cast<unsigned>(graphics::states::ComparisonFunction::NotEqual) == static_cast<unsigned>(D3DCMP_NOTEQUAL));
        static_assert(static_cast<unsigned>(graphics::states::ComparisonFunction::GreaterEqual) == static_cast<unsigned>(D3DCMP_GREATEREQUAL));
        static_assert(static_cast<unsigned>(graphics::states::ComparisonFunction::Always) == static_cast<unsigned>(D3DCMP_ALWAYS));
