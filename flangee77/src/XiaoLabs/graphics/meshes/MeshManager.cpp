...
namespace meshes {
     ...
     */
    resources::ResourceID MeshManager::_create_vertex_buffer(const cl7::string_view& identifier, const VertexBuffer::Desc& desc, const resources::DataProvider& data_provider)
    {
     ...
     */
    resources::ResourceID MeshManager::_create_index_buffer(const cl7::string_view& identifier, const IndexBuffer::Desc& desc, const resources::DataProvider& data_provider)
    {
