...
namespace tl7 {
    ...
    SubcaseBranchSwitch::SubcaseBranchSwitch(Context& ctx, cl7::u8string_view name, const char* file_path, unsigned line_number, signed iteration_number)
        : _meta{cl7::u8string(name), file_path, line_number, iteration_number}
        , _ctx(ctx)
