...
namespace tl7 {
    ...
    {
        return Result( Result::OriginType::Check, outcome, original_expression, evaluated_expression, ctx.subcases.get_data_string(), file_path, line_number );
    }
    ...
    {
        return Result( Result::OriginType::Presumption, outcome, original_expression, evaluated_expression, ctx.subcases.get_data_string(), file_path, line_number );
    }
    ...
    {
        return Result( Result::OriginType::Assertion, outcome, original_expression, evaluated_expression, ctx.subcases.get_data_string(), file_path, line_number );
    }
