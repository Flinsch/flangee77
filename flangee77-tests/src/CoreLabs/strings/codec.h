#ifndef F77_TESTS_CL7_STRINGS_CODEC_H
#define F77_TESTS_CL7_STRINGS_CODEC_H

#include <CoreLabs/strings/codec.h>
#include <CoreLabs/strings/codec/AsciiCodec.h>
#include <CoreLabs/strings/codec/Utf8Codec.h>
#include <CoreLabs/strings/codec/Utf16Codec.h>
#include <CoreLabs/strings/codec/Utf32Codec.h>
#include <CoreLabs/strings/codec/EncodeBuffer.h>
#include <CoreLabs/strings/codec/DefaultErrorHandler.h>
...
namespace tl7::internals {
    inline
    cl7::u8string to_string(const cl7::strings::codec::Encoding& encoding)
    {
        switch ( encoding )
        {
        case cl7::strings::codec::Encoding::ASCII:     return u8"\"ASCII\"";
        case cl7::strings::codec::Encoding::UTF8:      return u8"\"UTF-8\"";
        case cl7::strings::codec::Encoding::UTF16:     return u8"\"UTF-16\"";
        case cl7::strings::codec::Encoding::UTF32:     return u8"\"UTF-32\"";
        default:
...
using MyErrorHandler = cl7::strings::codec::ErrorHandler;//cl7::strings::codec::DefaultErrorHandler;



TESTLABS_CASE( u8"CoreLabs:  strings:  codec:  AsciiCodec::encode_one" )
{
    struct Entry
    {
        cl7::strings::codec::codepoint codepoint;
        cl7::strings::codec::CodepointResult codepoint_result;
        std::vector<cl7::achar_t> output_written;
        cl7::strings::codec::ErrorStatus error_status;
    } entry;
    ...
    const std::vector<Entry> container {
        ...
        { 0x0080, { {0x001a} }, {0x1a}, cl7::strings::codec::EncodingError::OutOfRangeAscii },
        { 0x00ff, { {0x001a} }, {0x1a}, cl7::strings::codec::EncodingError::OutOfRangeAscii },
        { 0x07ff, { {0x001a} }, {0x1a}, cl7::strings::codec::EncodingError::OutOfRangeAscii },
        { 0x0800, { {0x001a} }, {0x1a}, cl7::strings::codec::EncodingError::OutOfRangeAscii },

        { 0xd7ff, { {0x001a} }, {0x1a}, cl7::strings::codec::EncodingError::OutOfRangeAscii },
        { 0xd800, { {0x001a} }, {0x1a}, cl7::strings::codec::EncodingError::OutOfRangeAscii },
        { 0xdbff, { {0x001a} }, {0x1a}, cl7::strings::codec::EncodingError::OutOfRangeAscii },
        { 0xdc00, { {0x001a} }, {0x1a}, cl7::strings::codec::EncodingError::OutOfRangeAscii },
        { 0xdfff, { {0x001a} }, {0x1a}, cl7::strings::codec::EncodingError::OutOfRangeAscii },
        { 0xe000, { {0x001a} }, {0x1a}, cl7::strings::codec::EncodingError::OutOfRangeAscii },

        { 0xfffd, { {0x001a} }, {0x1a}, cl7::strings::codec::EncodingError::OutOfRangeAscii },
        { 0xffff, { {0x001a} }, {0x1a}, cl7::strings::codec::EncodingError::OutOfRangeAscii },
        { 0x10000, { {0x001a} }, {0x1a}, cl7::strings::codec::EncodingError::OutOfRangeAscii },
        { 0x10ffff, { {0x001a} }, {0x1a}, cl7::strings::codec::EncodingError::OutOfRangeAscii },
        { 0x110000, { {0x001a} }, {0x1a}, cl7::strings::codec::EncodingError::OutOfRangeAscii },
    };

    TESTLABS_SUBCASE_BATCH( u8"", container, entry )
    {
        cl7::strings::codec::EncodeBuffer<cl7::achar_t> buffer;

        {
            cl7::strings::codec::ErrorStatus error_status;
            cl7::strings::codec::AsciiCodec::EncodeResult encode_result = cl7::strings::codec::AsciiCodec::encode_one( error_status, entry.codepoint, buffer.string_span(), MyErrorHandler{} );
        ...
        {
            cl7::strings::codec::ErrorStatus error_status;
            cl7::strings::codec::AsciiCodec::EncodeResult encode_result = cl7::strings::codec::AsciiCodec::encode_one( error_status, entry.codepoint, {}, MyErrorHandler{} );
            TESTLABS_CHECK_EQ( static_cast<unsigned>( error_status.error ), static_cast<unsigned>( entry.error_status.error | cl7::strings::codec::EncodingError::ExhaustedOutputSpace ) );
...
TESTLABS_CASE( u8"CoreLabs:  strings:  codec:  AsciiCodec::decode_one" )
{
    struct Entry
    {
    ...
    const std::vector<Entry> container {
        ...
        { {0x80}, { {0x001a} }, 1, cl7::strings::codec::EncodingError::InvalidCodeUnit },
        { {0xff}, { {0x001a} }, 1, cl7::strings::codec::EncodingError::InvalidCodeUnit },
    };

    TESTLABS_SUBCASE_BATCH( u8"", container, entry )
    {
        cl7::strings::codec::ErrorStatus error_status;
        cl7::strings::codec::AsciiCodec::DecodeResult decode_result = cl7::strings::codec::AsciiCodec::decode_one( error_status, cl7::astring_view(reinterpret_cast<const cl7::achar_t*>(entry.input.data()), entry.input.size()), MyErrorHandler{} );
        TESTLABS_CHECK_EQ( static_cast<unsigned>( error_status.error ), static_cast<unsigned>( entry.error_status.error ) );
        TESTLABS_CHECK_EQ( error_status.error_count, entry.error_status.error_count );
...
TESTLABS_CASE( u8"CoreLabs:  strings:  codec:  Utf8Codec::encode_one" )
{
    struct Entry
    {
        cl7::strings::codec::codepoint codepoint;
    ...
    const std::vector<Entry> container {
        ...
        { 0xd800, { {0xfffd} }, {0xef, 0xbf, 0xbd}, cl7::strings::codec::EncodingError::DisallowedUnicode },
        { 0xdbff, { {0xfffd} }, {0xef, 0xbf, 0xbd}, cl7::strings::codec::EncodingError::DisallowedUnicode },
        { 0xdc00, { {0xfffd} }, {0xef, 0xbf, 0xbd}, cl7::strings::codec::EncodingError::DisallowedUnicode },
        { 0xdfff, { {0xfffd} }, {0xef, 0xbf, 0xbd}, cl7::strings::codec::EncodingError::DisallowedUnicode },
        ...
        { 0x110000, { {0xfffd} }, {0xef, 0xbf, 0xbd}, cl7::strings::codec::EncodingError::OutOfRangeUnicode },
    };

    TESTLABS_SUBCASE_BATCH( u8"", container, entry )
    {
        cl7::strings::codec::EncodeBuffer<cl7::u8char_t> buffer;

        {
            cl7::strings::codec::ErrorStatus error_status;
            cl7::strings::codec::Utf8Codec::EncodeResult encode_result = cl7::strings::codec::Utf8Codec::encode_one( error_status, entry.codepoint, buffer.string_span(), MyErrorHandler{} );
            TESTLABS_CHECK_EQ( static_cast<unsigned>( error_status.error ), static_cast<unsigned>( entry.error_status.error ) );
            TESTLABS_CHECK_EQ( error_status.error_count, entry.error_status.error_count );
            TESTLABS_CHECK_EQ( encode_result.codepoint.value, entry.codepoint_result.codepoint.value );
            ...
            TESTLABS_CHECK_EQ( encode_result.output_written.size(), cl7::strings::codec::Utf8Codec::determine_encode_length( entry.codepoint ) );
        }

        {
            cl7::strings::codec::ErrorStatus error_status;
            cl7::strings::codec::Utf8Codec::EncodeResult encode_result = cl7::strings::codec::Utf8Codec::encode_one( error_status, entry.codepoint, {}, MyErrorHandler{} );
            TESTLABS_CHECK_EQ( static_cast<unsigned>( error_status.error ), static_cast<unsigned>( entry.error_status.error | cl7::strings::codec::EncodingError::ExhaustedOutputSpace ) );
            TESTLABS_CHECK_EQ( error_status.error_count, entry.error_status.error_count + 1 );
            TESTLABS_CHECK_EQ( encode_result.codepoint.value, entry.codepoint_result.codepoint.value );
        ...
        {
            cl7::strings::codec::ErrorStatus error_status;
            cl7::strings::codec::Utf8Codec::EncodeResult encode_result = cl7::strings::codec::Utf8Codec::encode_one( error_status, entry.codepoint, buffer.string_span().subspan(0, entry.output_written.size() - 1), MyErrorHandler{} );
            TESTLABS_CHECK_EQ( static_cast<unsigned>( error_status.error ), static_cast<unsigned>( entry.error_status.error | cl7::strings::codec::EncodingError::InsufficientOutputSpace ) );
            TESTLABS_CHECK_EQ( error_status.error_count, entry.error_status.error_count + 1 );
            TESTLABS_CHECK_EQ( encode_result.codepoint.value, entry.codepoint_result.codepoint.value );
...
TESTLABS_CASE( u8"CoreLabs:  strings:  codec:  Utf8Codec::decode_one" )
{
    struct Entry
    {
        std::vector<uint8_t> input;
    ...
    const std::vector<Entry> container {
        ...
        { {0x80}, { {0xfffd} }, 1, cl7::strings::codec::EncodingError::InvalidCodeUnit },
        { {0xbf}, { {0xfffd} }, 1, cl7::strings::codec::EncodingError::InvalidCodeUnit },

        { {0xc0, 0x80}, { {0xfffd} }, 2, cl7::strings::codec::EncodingError::OverlongEncoding },
        { {0xc1, 0xbf}, { {0xfffd} }, 2, cl7::strings::codec::EncodingError::OverlongEncoding },

        { {0xc2, 0x80}, { {0x0080} }, 2 },
        { {0xc3, 0xbf}, { {0x00ff} }, 2 },
        { {0xdf, 0xbf}, { {0x07ff} }, 2 },
        { {0xe0, 0x80, 0x80}, { {0xfffd} }, 3, cl7::strings::codec::EncodingError::OverlongEncoding },
        { {0xe0, 0x9f, 0xbf}, { {0xfffd} }, 3, cl7::strings::codec::EncodingError::OverlongEncoding },
        { {0xe0, 0xa0, 0x80}, { {0x0800} }, 3 },
        { {0xe1, 0xa0, 0x20}, { {0xfffd} }, 2, cl7::strings::codec::EncodingError::IncompleteSequence },

        { {0xed, 0x9f, 0xbf}, { {0xd7ff} }, 3 },
        { {0xed, 0xa0, 0x80}, { {0xfffd} }, 3, cl7::strings::codec::EncodingError::InvalidSequence },
        { {0xed, 0xaf, 0xbf}, { {0xfffd} }, 3, cl7::strings::codec::EncodingError::InvalidSequence },
        { {0xed, 0xb0, 0x80}, { {0xfffd} }, 3, cl7::strings::codec::EncodingError::InvalidSequence },
        { {0xed, 0xbf, 0xbf}, { {0xfffd} }, 3, cl7::strings::codec::EncodingError::InvalidSequence },
        { {0xee, 0x80, 0x80}, { {0xe000} }, 3 },

        { {0xef, 0xbf, 0xbd}, { {0xfffd} }, 3 },
        { {0xef, 0xbf, 0xbf}, { {0xffff} }, 3 },
        { {0xf0, 0x80, 0x80, 0x80}, { {0xfffd} }, 4, cl7::strings::codec::EncodingError::OverlongEncoding },
        { {0xf0, 0x8f, 0xbf, 0xbf}, { {0xfffd} }, 4, cl7::strings::codec::EncodingError::OverlongEncoding },
        { {0xf0, 0x90, 0x80, 0x80}, { {0x10000} }, 4 },
        { {0xf4, 0x8f, 0xbf, 0xbf}, { {0x10ffff} }, 4 },
        { {0xf4, 0x90, 0x80, 0x80}, { {0xfffd} }, 4, cl7::strings::codec::EncodingError::InvalidSequence },
        { {0xf5, 0x80, 0x80, 0x80, 0x80}, { {0xfffd} }, 4, cl7::strings::codec::EncodingError::InvalidSequence },
        { {0xf7, 0x80, 0x7f, 0x80, 0x80}, { {0xfffd} }, 2, cl7::strings::codec::EncodingError::InvalidSequence },
        { {0xf8, 0x80, 0x80, 0x80, 0x80, 0x80}, { {0xfffd} }, 5, cl7::strings::codec::EncodingError::InvalidSequence },
        { {0xfb, 0x80, 0x7f, 0x80, 0x80, 0x80}, { {0xfffd} }, 2, cl7::strings::codec::EncodingError::InvalidSequence },
        { {0xfc, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80}, { {0xfffd} }, 6, cl7::strings::codec::EncodingError::InvalidSequence },
        { {0xfd, 0x80, 0x7f, 0x80, 0x80, 0x80, 0x80}, { {0xfffd} }, 2, cl7::strings::codec::EncodingError::InvalidSequence },
        { {0xfe, 0x80}, { {0xfffd} }, 1, cl7::strings::codec::EncodingError::InvalidCodeUnit },
        { {0xff, 0x80}, { {0xfffd} }, 1, cl7::strings::codec::EncodingError::InvalidCodeUnit },
    };
    ...
    TESTLABS_SUBCASE_BATCH( u8"", container, entry )
    {
        ...
        cl7::strings::codec::Utf8Codec::DecodeResult decode_result = cl7::strings::codec::Utf8Codec::decode_one( error_status, input, MyErrorHandler{} );
        TESTLABS_CHECK_EQ( static_cast<unsigned>( error_status.error ), static_cast<unsigned>( entry.error_status.error ) );
        TESTLABS_CHECK_EQ( error_status.error_count, entry.error_status.error_count );
        TESTLABS_CHECK_EQ( decode_result.codepoint.value, entry.codepoint_result.codepoint.value );
        TESTLABS_CHECK_EQ( decode_result.input_read.size(), entry.input_read_size );

        TESTLABS_CHECK_EQ( decode_result.input_read.size(), cl7::strings::codec::Utf8Codec::determine_decode_length( input ) );
    }
}



TESTLABS_CASE( u8"CoreLabs:  strings:  codec:  Utf16Codec::encode_one" )
{
    struct Entry
    {
        cl7::strings::codec::codepoint codepoint;
    ...
    const std::vector<Entry> container {
        ...
        { 0xd800, { {0xfffd} }, {0xfffd}, cl7::strings::codec::EncodingError::DisallowedUnicode },
        { 0xdbff, { {0xfffd} }, {0xfffd}, cl7::strings::codec::EncodingError::DisallowedUnicode },
        { 0xdc00, { {0xfffd} }, {0xfffd}, cl7::strings::codec::EncodingError::DisallowedUnicode },
        { 0xdfff, { {0xfffd} }, {0xfffd}, cl7::strings::codec::EncodingError::DisallowedUnicode },
        ...
        { 0x110000, { {0xfffd} }, {0xfffd}, cl7::strings::codec::EncodingError::OutOfRangeUnicode },
    };

    TESTLABS_SUBCASE_BATCH( u8"", container, entry )
    {
        cl7::strings::codec::EncodeBuffer<cl7::u16char_t> buffer;

        {
            cl7::strings::codec::ErrorStatus error_status;
            cl7::strings::codec::Utf16Codec::EncodeResult encode_result = cl7::strings::codec::Utf16Codec::encode_one( error_status, entry.codepoint, buffer.string_span(), MyErrorHandler{} );
            TESTLABS_CHECK_EQ( static_cast<unsigned>( error_status.error ), static_cast<unsigned>( entry.error_status.error ) );
            TESTLABS_CHECK_EQ( error_status.error_count, entry.error_status.error_count );
            TESTLABS_CHECK_EQ( encode_result.codepoint.value, entry.codepoint_result.codepoint.value );
            ...
            TESTLABS_CHECK_EQ( encode_result.output_written.size(), cl7::strings::codec::Utf16Codec::determine_encode_length( entry.codepoint ) );
        }

        {
            cl7::strings::codec::ErrorStatus error_status;
            cl7::strings::codec::Utf16Codec::EncodeResult encode_result = cl7::strings::codec::Utf16Codec::encode_one( error_status, entry.codepoint, {}, MyErrorHandler{} );
            TESTLABS_CHECK_EQ( static_cast<unsigned>( error_status.error ), static_cast<unsigned>( entry.error_status.error | cl7::strings::codec::EncodingError::ExhaustedOutputSpace ) );
            TESTLABS_CHECK_EQ( error_status.error_count, entry.error_status.error_count + 1 );
            TESTLABS_CHECK_EQ( encode_result.codepoint.value, entry.codepoint_result.codepoint.value );
        ...
        {
            cl7::strings::codec::ErrorStatus error_status;
            cl7::strings::codec::Utf16Codec::EncodeResult encode_result = cl7::strings::codec::Utf16Codec::encode_one( error_status, entry.codepoint, buffer.string_span().subspan(0, entry.output_written.size() - 1), MyErrorHandler{} );
            TESTLABS_CHECK_EQ( static_cast<unsigned>( error_status.error ), static_cast<unsigned>( entry.error_status.error | cl7::strings::codec::EncodingError::InsufficientOutputSpace ) );
            TESTLABS_CHECK_EQ( error_status.error_count, entry.error_status.error_count + 1 );
            TESTLABS_CHECK_EQ( encode_result.codepoint.value, entry.codepoint_result.codepoint.value );
...
TESTLABS_CASE( u8"CoreLabs:  strings:  codec:  Utf16Codec::decode_one" )
{
    struct Entry
    {
    ...
    const std::vector<Entry> container {
        ...
        { {0xd7ff}, { {0xd7ff} }, 1 },
        { {0xd800}, { {0xfffd} }, 1, cl7::strings::codec::EncodingError::IncompleteSequence },
        { {0xdbff}, { {0xfffd} }, 1, cl7::strings::codec::EncodingError::IncompleteSequence },
        { {0xdc00}, { {0xfffd} }, 1, cl7::strings::codec::EncodingError::UnpairedSurrogate },
        { {0xdfff}, { {0xfffd} }, 1, cl7::strings::codec::EncodingError::UnpairedSurrogate },
        { {0xe000}, { {0xe000} }, 1 },
        ...
        //{ {0x110000}, { {0xfffd} }, 1, cl7::strings::codec::EncodingError::InvalidCodeUnit },
    };
    ...
    TESTLABS_SUBCASE_BATCH( u8"", container, entry )
    {
        ...
        cl7::strings::codec::Utf16Codec::DecodeResult decode_result = cl7::strings::codec::Utf16Codec::decode_one( error_status, input, MyErrorHandler{} );
        TESTLABS_CHECK_EQ( static_cast<unsigned>( error_status.error ), static_cast<unsigned>( entry.error_status.error ) );
        TESTLABS_CHECK_EQ( error_status.error_count, entry.error_status.error_count );
        TESTLABS_CHECK_EQ( decode_result.codepoint.value, entry.codepoint_result.codepoint.value );
        TESTLABS_CHECK_EQ( decode_result.input_read.size(), entry.input_read_size );

        TESTLABS_CHECK_EQ( decode_result.input_read.size(), cl7::strings::codec::Utf16Codec::determine_decode_length( input ) );
    }
}



TESTLABS_CASE( u8"CoreLabs:  strings:  codec:  Utf32Codec::encode_one" )
{
    struct Entry
    {
        cl7::strings::codec::codepoint codepoint;
    ...
    TESTLABS_SUBCASE_BATCH( u8"", container, entry )
    {
        cl7::strings::codec::EncodeBuffer<cl7::u32char_t> buffer;

        {
            cl7::strings::codec::ErrorStatus error_status;
            cl7::strings::codec::Utf32Codec::EncodeResult encode_result = cl7::strings::codec::Utf32Codec::encode_one( error_status, entry.codepoint, buffer.string_span(), MyErrorHandler{} );
            TESTLABS_CHECK_EQ( static_cast<unsigned>( error_status.error ), static_cast<unsigned>( entry.error_status.error ) );
            TESTLABS_CHECK_EQ( error_status.error_count, entry.error_status.error_count );
            TESTLABS_CHECK_EQ( encode_result.codepoint.value, entry.codepoint_result.codepoint.value );
        ...
        {
            cl7::strings::codec::ErrorStatus error_status;
            cl7::strings::codec::Utf32Codec::EncodeResult encode_result = cl7::strings::codec::Utf32Codec::encode_one( error_status, entry.codepoint, {}, MyErrorHandler{} );
            TESTLABS_CHECK_EQ( static_cast<unsigned>( error_status.error ), static_cast<unsigned>( entry.error_status.error | cl7::strings::codec::EncodingError::ExhaustedOutputSpace ) );
            TESTLABS_CHECK_EQ( error_status.error_count, entry.error_status.error_count + 1 );
            TESTLABS_CHECK_EQ( encode_result.codepoint.value, entry.codepoint_result.codepoint.value );
...
TESTLABS_CASE( u8"CoreLabs:  strings:  codec:  Utf32Codec::decode_one" )
{
    struct Entry
    {
    ...
    const std::vector<Entry> container {
        ...
        { {0xd7ff}, { {0xd7ff} }, 1 },
        { {0xd800}, { {0xfffd} }, 1, cl7::strings::codec::EncodingError::InvalidCodeUnit },
        { {0xdbff}, { {0xfffd} }, 1, cl7::strings::codec::EncodingError::InvalidCodeUnit },
        { {0xdc00}, { {0xfffd} }, 1, cl7::strings::codec::EncodingError::InvalidCodeUnit },
        { {0xdfff}, { {0xfffd} }, 1, cl7::strings::codec::EncodingError::InvalidCodeUnit },
        { {0xe000}, { {0xe000} }, 1 },
    ...
    {
        cl7::strings::codec::ErrorStatus error_status;
        cl7::strings::codec::Utf32Codec::DecodeResult decode_result = cl7::strings::codec::Utf32Codec::decode_one( error_status, cl7::u32string_view(reinterpret_cast<const cl7::u32char_t*>(entry.input.data()), entry.input.size()), MyErrorHandler{} );
        TESTLABS_CHECK_EQ( static_cast<unsigned>( error_status.error ), static_cast<unsigned>( entry.error_status.error ) );
        TESTLABS_CHECK_EQ( error_status.error_count, entry.error_status.error_count );
        TESTLABS_CHECK_EQ( decode_result.codepoint.value, entry.codepoint_result.codepoint.value );
        TESTLABS_CHECK_EQ( decode_result.input_read.size(), entry.input_read_size );
...
TESTLABS_CASE( (u8"CoreLabs:  strings:  codec:  to ASCII from " from) ) \
{ \
    struct Entry \
    { \
        type input; \
 ...
 \
    ...
    { \
        auto actual = cl7::strings::codec::to_ascii( entry.input ); \
...
TESTLABS_CASE( u8"CoreLabs:  strings:  codec:  to UTF-8 from ASCII" )
{
    struct Entry
    {
    ...
    {
        auto actual = cl7::strings::codec::to_utf8( entry.input );
        TESTLABS_CHECK_EQ( actual, entry.expected );
...
TESTLABS_CASE( (u8"CoreLabs:  strings:  codec:  to " to " from ASCII") ) \
{ \
    struct Entry \
    { \
        cl7::astring_view input; \
 ...
 \
    ...
    { \
        auto actual = cl7::strings::codec::to_utfx( entry.input ); \
        TESTLABS_CHECK_EQ( actual, entry.expected ); \
    } \
}
...
TESTLABS_CASE( (u8"CoreLabs:  strings:  codec:  to UTF-8 from " from) ) \
{ \
    struct Entry \
    { \
        type input; \
...
TESTLABS_CASE( (u8"CoreLabs:  strings:  codec:  to " to " from UTF-8") ) \
{ \
    struct Entry \
    { \
...
TESTLABS_CASE( u8"CoreLabs:  strings:  codec:  between UTF-16 and UTF-32" )
{
    struct Entry
    {
    ...
    TESTLABS_SUBCASE_BATCH_WITH_DATA_STRING( u8"between UTF-16 and UTF-32", container, entry, entry.comment )
    {
        ...
        auto actual_u16s = cl7::strings::codec::to_utf16( entry.u32s );
        auto actual_u32s = cl7::strings::codec::to_utf32( entry_u16s );
...
TESTLABS_CASE( u8"CoreLabs:  strings::to_ascii(u32string_view)" )
{
    for ( cl7::u32char_t u32c = 0; u32c <= 0x7f; ++u32c )
    {
        ...
        TESTLABS_CHECK_EQ( cl7::strings::codec::to_ascii( u32s ), as );
    }
...
TESTLABS_CASE( u8"CoreLabs:  strings::to_utf8(u32string_view)" )
{
    ...
    TESTLABS_SUBCASE_BATCH_WITH_DATA_STRING( u8"", container, entry, entry.comment )
    {
        ...
        TESTLABS_CHECK_EQ( cl7::strings::codec::to_utf8( u32s ), u8s );
    }
}
...
TESTLABS_CASE( u8"CoreLabs:  strings::to_utf16(u32string_view)" )
{
    ...
    TESTLABS_SUBCASE_BATCH_WITH_DATA_STRING( u8"", container, entry, entry.comment )
    {
        ...
        TESTLABS_CHECK_EQ( cl7::strings::codec::to_utf16( u32s ), u16s );
    }
}
...
TESTLABS_CASE( u8"CoreLabs:  strings::to_ascii_unchecked(byte_view)" )
{
    ...
    {
        TESTLABS_CHECK_EQ( cl7::strings::codec::to_ascii_unchecked( entry.input ), entry.expected );
    }
}
...
TESTLABS_CASE( u8"CoreLabs:  strings::to_utf8_unchecked(byte_view)" )
{
    ...
    TESTLABS_SUBCASE_BATCH_WITH_DATA_STRING( u8"", container, entry, entry.expected )
    {
        auto actual = cl7::strings::codec::to_utf8_unchecked( entry.input );
        TESTLABS_CHECK_EQ( actual, entry.expected );
        TESTLABS_CHECK_EQ( actual.size(), entry.byte_count );
    }
}
...
TESTLABS_CASE( u8"CoreLabs:  strings::to_utf16_unchecked(byte_view)" )
{
    ...
    TESTLABS_SUBCASE_BATCH_WITH_DATA_STRING( u8"", container, entry, entry.expected )
    {
        auto actual = cl7::strings::codec::to_utf16_unchecked( entry.input );
        TESTLABS_CHECK_EQ( actual, entry.expected );
...
TESTLABS_CASE( u8"CoreLabs:  strings::to_utf32_unchecked(byte_view)" )
{
    ...
    TESTLABS_SUBCASE_BATCH_WITH_DATA_STRING( u8"", container, entry, entry.expected )
    {
        auto actual = cl7::strings::codec::to_utf32_unchecked( entry.input );
        TESTLABS_CHECK_EQ( actual, entry.expected );
        TESTLABS_CHECK_EQ( actual.size(), entry.unit_count );
    }
}
...
TESTLABS_CASE( u8"CoreLabs:  strings::to_bytes(astring_view)" )
{
    ...
    {
        TESTLABS_CHECK_EQ( cl7::strings::codec::to_bytes( entry.input ), entry.expected );
    }
}
...
TESTLABS_CASE( u8"CoreLabs:  strings::to_bytes(u8string_view, bool)" )
{
    ...
    TESTLABS_SUBCASE_BATCH_WITH_DATA_STRING( u8"", container, entry, entry.input )
    {
        TESTLABS_CHECK_EQ( cl7::strings::codec::to_bytes( entry.input, entry.add_bom ), entry.expected );
    }
}
...
TESTLABS_CASE( u8"CoreLabs:  strings::to_bytes(u16string_view, bool, std::endian)" )
{
    ...
    TESTLABS_SUBCASE_BATCH_WITH_DATA_STRING( u8"", container, entry, entry.input )
    {
        TESTLABS_CHECK_EQ( cl7::strings::codec::to_bytes( entry.input, entry.add_bom, entry.endian ), entry.expected );
    }
}
...
TESTLABS_CASE( u8"CoreLabs:  strings::check_ascii(astring_view)" )
{
    ...
    TESTLABS_SUBCASE_BATCH_WITH_DATA_STRING( u8"", container, entry, entry.input )
    {
        TESTLABS_CHECK_EQ( cl7::strings::codec::check_ascii( entry.input ), entry.expected );
    }
}
...
TESTLABS_CASE( u8"CoreLabs:  strings::parse_utf8(u8string_view, u32string&)" )
{
    ...
    TESTLABS_SUBCASE_BATCH_WITH_DATA_STRING( u8"", container, entry, entry.expected )
    {
        ...
        TESTLABS_CHECK_EQ( cl7::strings::codec::parse_utf8( input, actual ), entry.check );
        TESTLABS_CHECK_EQ( actual, entry.expected );
    }
}
...
TESTLABS_CASE( u8"CoreLabs:  strings::parse_utf16(u16string_view, u32string&)" )
{
    ...
    TESTLABS_SUBCASE_BATCH_WITH_DATA_STRING( u8"", container, entry, entry.expected )
    {
        ...
        cl7::u32string actual;
        TESTLABS_CHECK_EQ( cl7::strings::codec::parse_utf16( input, actual ), entry.check );
        TESTLABS_CHECK_EQ( actual, entry.expected );
    }
}
...
TESTLABS_CASE( u8"CoreLabs:  strings::check_utf32(u32string_view)" )
{
    ...
    TESTLABS_SUBCASE_BATCH_WITH_DATA_STRING( u8"", container, entry, entry.expected )
    {
        ...
        TESTLABS_CHECK_EQ( cl7::strings::codec::check_utf32( input ), entry.expected );
    }
}
...
TESTLABS_CASE( u8"CoreLabs:  strings::utf8_length(u8string_view)" )
{
    ...
    {
        cl7::u8string_view input( reinterpret_cast<const cl7::u8char_t*>( entry.input_data.data() ) );
        TESTLABS_CHECK_EQ( cl7::strings::codec::utf8_length( input ), entry.expected );
    }
}
...
TESTLABS_CASE( u8"CoreLabs:  strings::utf16_length(u16string_view)" )
{
    ...
    TESTLABS_SUBCASE_BATCH_WITH_DATA_STRING( u8"", container, entry, entry.comment )
    {
        ...
        cl7::u16string_view input( reinterpret_cast<const cl7::u16char_t*>( &entry.input_data[0] ) );
        TESTLABS_CHECK_EQ( cl7::strings::codec::utf16_length( input ), entry.expected );
    }
}



TESTLABS_CASE( u8"CoreLabs:  strings:  codec:  detect_encoding" )
{
    struct Entry
    {
        cl7::byte_vector input;
        cl7::strings::codec::Encoding expected;
    } entry;

    const std::vector<Entry> container {
        { {}, cl7::strings::codec::Encoding::Unknown },
        { cl7::strings::codec::to_bytes( "ASCII: Oelrueckstossabdaempfung" ), cl7::strings::codec::Encoding::ASCII },
        { cl7::strings::codec::to_bytes( u8"UTF-8: \u00d6lr\u00fccksto\u00dfabd\u00e4mpfung" ), cl7::strings::codec::Encoding::UTF8 },
        { cl7::strings::codec::to_bytes( u"UTF-16: \u00d6lr\u00fccksto\u00dfabd\u00e4mpfung" ), cl7::strings::codec::Encoding::UTF16 },
        { cl7::strings::codec::to_bytes( U"UTF-32: \u00d6lr\u00fccksto\u00dfabd\u00e4mpfung" ), cl7::strings::codec::Encoding::UTF32 },
    };
    ...
    TESTLABS_SUBCASE_BATCH_WITH_DATA_STRING( u8"", container, entry, entry.input )
    {
        ...
        auto actual = cl7::strings::codec::detect_encoding( input );
...
#endif // F77_TESTS_CL7_STRINGS_CODEC_H
