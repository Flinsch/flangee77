...
TESTLABS_CASE( u8"CoreLabs:  io:  ByteWriter" )
{
    ...
    TESTLABS_CHECK_EQ( cl7::to_bytes(writable_memory.get_data()), cl7::make_bytes( 0x7f, 0x01, 0x02, 0x03, 0x04, 0x12, 0x34, 0x56, 0x78, 0x78, 0x56, 0x34, 0x12, 0x01, 0x02, 0x03, 0x04 ) );
}
