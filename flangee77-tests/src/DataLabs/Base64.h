...
TESTLABS_CASE( u8"CoreLabs:  Base64:  encode/decode" )
{
    ...
    const std::vector<Entry> container {
        ...
        { cl7::strings::codec::to_bytes( "Hello, World!" ), u8"SGVsbG8sIFdvcmxkIQ", without_padding },
        { cl7::strings::codec::to_bytes( "Dr. Stefan Fleischer" ), u8"RHIuIFN0ZWZhbiBGbGVpc2NoZXI", without_padding },
        { cl7::strings::codec::to_bytes( "The quick brown fox jumps over the lazy dog." ), u8"VGhlIHF1aWNrIGJyb3duIGZveCBqdW1wcyBvdmVyIHRoZSBsYXp5IGRvZy4", without_padding },
        { cl7::strings::codec::to_bytes( "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum." ), u8"", without_padding },
        ...
        { cl7::strings::codec::to_bytes( "Hello, World!" ), u8"SGVsbG8sIFdvcmxkIQ==", other_characters },
        { cl7::strings::codec::to_bytes( "Dr. Stefan Fleischer" ), u8"RHIuIFN0ZWZhbiBGbGVpc2NoZXI=", other_characters },
        { cl7::strings::codec::to_bytes( "The quick brown fox jumps over the lazy dog." ), u8"VGhlIHF1aWNrIGJyb3duIGZveCBqdW1wcyBvdmVyIHRoZSBsYXp5IGRvZy4=", other_characters },
        { cl7::strings::codec::to_bytes( "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum." ), u8"", other_characters },
        ...
        { cl7::strings::codec::to_bytes( "Hello, World!" ), u8"SGVsbG8sIFdvcmxkIQ==", insert_breaks },
        { cl7::strings::codec::to_bytes( "Dr. Stefan Fleischer" ), u8"RHIuIFN0ZWZhbiBGbGVpc2NoZXI=", insert_breaks },
        { cl7::strings::codec::to_bytes( "The quick brown fox jumps over the lazy dog." ), u8"VGhlIHF1aWNrIGJyb3duIGZveCBqdW1wcyBvdmVyIHRoZSBsYXp5IGRvZy4=", insert_breaks },
