...
TESTLABS_CASE( u8"DataLabs:  ini:  IniWriter:  to_string" )
{
    ...
    const std::vector<Entry> container {
        ...
        { dl7::ini::Ini( dl7::ini::Ini::properties_t{ { u8"foo", dl7::ini::Value( u8"bar" ) } } ), (format = dl7::ini::IniWriter::DEFAULT_COMPACT_FORMAT, format.newline = dl7::ini::Format::Newline::CRLF, format), u8"foo=bar\r\n" },
        { dl7::ini::Ini( dl7::ini::Ini::properties_t{ { u8"foo", dl7::ini::Value( u8"bar" ) } } ), (format = dl7::ini::IniWriter::DEFAULT_COMPACT_FORMAT, format.newline = dl7::ini::Format::Newline::LF, format), u8"foo=bar\n" },
        { dl7::ini::Ini( dl7::ini::Ini::properties_t{ { u8"foo", dl7::ini::Value( u8"bar" ) } } ), (format = dl7::ini::IniWriter::DEFAULT_COMPACT_FORMAT, format.newline = dl7::ini::Format::Newline::CR, format), u8"foo=bar\r" },
