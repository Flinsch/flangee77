...
TESTLABS_CASE( u8"CoreLabs:  LineSegment2:  " )
{
    ...
    TESTLABS_CHECK_EQ( ml7::LineSegment2( ml7::Vector2( 1.0f, 2.0f ), ml7::Vector2( -2.0f, 6.0f ) ).distance_squared( ml7::Vector2( 4.0f, -2.0f ) ), 25.0f );
    TESTLABS_CHECK_EQ( ml7::LineSegment2( ml7::Vector2( 1.0f, 2.0f ), ml7::Vector2( -2.0f, 6.0f ) ).distance_squared( ml7::Vector2( 1.0f, 2.0f ) ), 0.0f );
    TESTLABS_CHECK_EQ( ml7::LineSegment2( ml7::Vector2( 1.0f, 2.0f ), ml7::Vector2( -2.0f, 6.0f ) ).distance_squared( ml7::Vector2( -0.5f, 4.0f ) ), 0.0f );
    TESTLABS_CHECK_EQ( ml7::LineSegment2( ml7::Vector2( 1.0f, 2.0f ), ml7::Vector2( -2.0f, 6.0f ) ).distance_squared( ml7::Vector2( -2.0f, 6.0f ) ), 0.0f );
    TESTLABS_CHECK_EQ( ml7::LineSegment2( ml7::Vector2( 1.0f, 2.0f ), ml7::Vector2( -2.0f, 6.0f ) ).distance_squared( ml7::Vector2( -5.0f, 10.0f ) ), 25.0f );
    TESTLABS_CHECK_EQ( ml7::LineSegment2( ml7::Vector2( 1.0f, 2.0f ), ml7::Vector2( -2.0f, 6.0f ) ).distance_squared( ml7::Vector2( 0.0f, -5.0f ) ), 50.0f );
    TESTLABS_CHECK_EQ( ml7::LineSegment2( ml7::Vector2( 1.0f, 2.0f ), ml7::Vector2( -2.0f, 6.0f ) ).distance_squared( ml7::Vector2( -3.0f, -1.0f ) ), 25.0f );
    TESTLABS_CHECK_EQ( ml7::LineSegment2( ml7::Vector2( 1.0f, 2.0f ), ml7::Vector2( -2.0f, 6.0f ) ).distance_squared( ml7::Vector2( -4.5f, 1.0f ) ), 25.0f );
    TESTLABS_CHECK_EQ( ml7::LineSegment2( ml7::Vector2( 1.0f, 2.0f ), ml7::Vector2( -2.0f, 6.0f ) ).distance_squared( ml7::Vector2( -6.0f, 3.0f ) ), 25.0f );
    TESTLABS_CHECK_EQ( ml7::LineSegment2( ml7::Vector2( 1.0f, 2.0f ), ml7::Vector2( -2.0f, 6.0f ) ).distance_squared( ml7::Vector2( -9.0f, 7.0f ) ), 50.0f );
    TESTLABS_CHECK_EQ( ml7::LineSegment2( ml7::Vector2( 1.0f, 2.0f ), ml7::Vector2( -2.0f, 6.0f ) ).distance_squared( ml7::Vector2( 8.0f, 1.0f ) ), 50.0f );
    TESTLABS_CHECK_EQ( ml7::LineSegment2( ml7::Vector2( 1.0f, 2.0f ), ml7::Vector2( -2.0f, 6.0f ) ).distance_squared( ml7::Vector2( 5.0f, 5.0f ) ), 25.0f );
    TESTLABS_CHECK_EQ( ml7::LineSegment2( ml7::Vector2( 1.0f, 2.0f ), ml7::Vector2( -2.0f, 6.0f ) ).distance_squared( ml7::Vector2( 3.5f, 7.0f ) ), 25.0f );
    TESTLABS_CHECK_EQ( ml7::LineSegment2( ml7::Vector2( 1.0f, 2.0f ), ml7::Vector2( -2.0f, 6.0f ) ).distance_squared( ml7::Vector2( 2.0f, 9.0f ) ), 25.0f );
    TESTLABS_CHECK_EQ( ml7::LineSegment2( ml7::Vector2( 1.0f, 2.0f ), ml7::Vector2( -2.0f, 6.0f ) ).distance_squared( ml7::Vector2( -1.0f, 13.0f ) ), 50.0f );
